...
> The `contenteditable` attribute can be used to quickly enable collaborative text editing in a
webstrate.
...
Let's try to make it possible to drag the note around on the screen. Before we do thism we will just
